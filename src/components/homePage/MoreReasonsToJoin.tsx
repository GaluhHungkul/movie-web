    ...
    <div className='w-full my-20'>
        ...
        <section className="grid gap-2 mt-10 md:grid-cols-2 md:gap-4 lg:grid-cols-4">
            {moreReasonsToJoin.map(item => (
                <div key={item.id} className="rounded-lg p-4 bg-gradient-to-br from-blue-500/40 via-purple-900/40 to-red-900/40  hover:-translate-y-2 duration-200 hover:bg-white/10 lg:px-8 lg:py-12">
                    <h1 className="mb-6 text-xl md:text-2xl md:mb-10 lg:text-xl lg:mb-6">{item.title}</h1>
                    <h2 className="mb-8 md:text-lg md:mb-12 lg:text-base">{item.content}</h2>
