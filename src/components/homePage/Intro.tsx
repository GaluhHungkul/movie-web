...
const Intro = () => { 
  return (
    <div className='flex flex-col items-center min-h-screen w-screen justify-end relative pb-28 mb-10'>
        ...
        <h1 className="text-3xl text-foreground text-center md:text-4xl lg:text-5xl">Stream Everything You Love, Instantly</h1>
