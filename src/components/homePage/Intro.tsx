...
const Intro = () => { 
  ...
  return (
    <div className='flex flex-col items-center min-h-screen w-screen justify-end relative pb-28'>
        ...
        <motion.p variants={fadeInUp} initial="hidden" whileInView={"show"} viewport={{ once: true }} className="text-center text-sm text-foreground font-medium mt-6 md:text-xl lg:text-2xl">Unlimited movies. Endless shows. Zero waiting. StreamVibe puts thousands of titles at your fingertips-new releases, classics, and everything in between.</motion.p>
