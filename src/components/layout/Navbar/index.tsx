...
const Navbar  = () => {
  ...
  return (
    <div className={`text-primary bg-background text-sm flex container justify-between py-4 content-center gap-8 lg:gap-12 font-bold items-center sticky top-0 z-[50]`}>
