...
const PreviewVideo = ({ preview_video_key } : { preview_video_key : string }) => {
  ...
  return (
    <div className={`fixed z-10 right-2 bottom-1 text-end aspect-[16/9] lg:w-96`}>
        ...
        {showVideo && <iframe src={`https://www.youtube.com/embed/${preview_video_key}`} className="size-full rounded"></iframe>}
    </div>
  )
}
